...
class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        assertNull( sphere.findIntersections(new Ray(new Point3D(3, 0, 0),
                new Vector(1, 1, 0))),"Wrong number of points");
        ...
        assertNull(sphere.findIntersections(new Ray(new Point3D(1, 1, 0),
                new Vector(0, 1, 1))),"Wrong number of points");
        ...
        result = sphere.findIntersections(new Ray(new Point3D(1, 2, 0),
                new Vector(0, -1, 0)));;
        assertEquals( 2, result.size(),"Wrong number of points");
        if (result.get(0).getY().getCoord() < result.get(1).getY().getCoord())
            result = List.of(result.get(1), result.get(0));
        assertEquals( List.of(p1, p2), result,"Ray crosses sphere");
        ...
        assertNull( sphere.findIntersections(new Ray(new Point3D(1, 1, 0),
                new Vector(0, 1, 0))),"Wrong number of points");
        ...
        assertNull(  sphere.findIntersections(new Ray(new Point3D(1, 1, 0),
                new Vector(1, 0, 0))),"Wrong number of points");
        // TC21: Ray starts after the tangent point

        assertNull(  sphere.findIntersections(new Ray(new Point3D(2, 2, 0),
                new Vector(1, 1, 0))),"Wrong number of points");
        // **** Group: Special cases
